...
For student privacy, the Gradescope and PrairieLearn download files

grades/CSE20_SP24_A00_Spring_2024_grades.csv
grades/CSE20W26gradebookfilteredPL.csv

and the output file 

grades/CSE20W26.grades.csv

should be kept local.  The notebook 

/Users/miaminneskemp/GitHub/discrete-math-for-cs/grades/analysis.ipynb

can be committed to the repo so long as the cells are not run!