...
These homework assignments must be done in groups of three students.
Please ensure your name(s) and TSN(s)
...
submission through their Gradescope account and then adds the other group members to the Gradescope submission
...
After you submit the PDF of the homework, you will meet with a TA for a Homework Q\&A session. This session is a primary component of your homework score. All group members must be present and able to fully participate in discussions of each question.
...
When discussing your homework solutions, you should be prepared to describe
\begin{itemize}
\item The key ideas that establish the correctness of any final answers.
\item What evidence demonstrates the soundness of your results and methods.
\item What would need to change in the solution to solve a similar but different question.
\end{itemize}
A rule of thumb for the level of detail to include is to imagine someone who is taking the class alongside you but missed about a week's worth of content: does your writeup have enough detail for them to learn from it?
...
\date{Due: 10/06/26 at 5pm (no penalty late submission until 8am next morning)}
\begin{document}
\maketitle
\thispagestyle{fancy}
