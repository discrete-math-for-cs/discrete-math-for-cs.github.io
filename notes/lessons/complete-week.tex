...
\newpage
\section*{Welcome to CSE 20: Discrete Math for CS in Winter 2026!}
...
CSE 20 team: One instructor + two TAs and three tutors + all of you
...
On a typical week in CSE 20: {\bf MWF} Lectures (sometimes with pre-class reading), {\bf M} Discussion + 
review quiz due, then (every second) {\bf Th} Homework due.
...
and Q+A on Piazza available throughout the week. CSE 20 has two in-term tests
and one final exam this quarter.
What you can find on the class website on \href{https://canvas.ucsd.edu/}{Canvas (https://canvas.ucsd.edu/)}:
...
\begin{list}
   {\itemsep2pt}
   \item \#FinAid Assignment on Canvas \url{https://canvas.ucsd.edu/courses/71479/quizzes/235977} (complete as soon as possible) 
   \item Review quiz based on class material (due Monday 01/12/2026)
   \item Homework assignment 1 (due Thursday 01/15/2026)
\end{list}
...
The review quiz is available on PrairieLearn at \url{https://us.prairielearn.com/pl/} and covers 
\begin{itemize}
\item Modeling
...
\begin{list}
   ...
   \item Review quiz based on Week 1 class material (due Monday 01/12/2026)
   \item Homework assignment 1 (due Thursday 01/15/2026)
   \item Review quiz based on Week 2 class material (due Monday 01/19/2026)
\end{list}
...
\item Use precise language to clearly present logical arguments and communicate with technical and non-technical colleagues.
\begin{itemize}
    \item Distinguishing between tautologies, contradictions, and contingencies
\end{itemize}
...
\begin{list}
   {\itemsep2pt}
   \item Review quiz based on Week 2 class material (extended because signed number representations weren't covered until Week 3; now due Monday 01/26/2026)
   \item Review quiz based on Week 3 class material (due Monday 01/26/2026)
\end{list}

\newpage
\section*{Week 3 Wednesday: Fixed-width Addition and Circuits}
...
\newpage
\section*{Week 3 Friday: Propositional Logic and Logical Equivalence}
...
\newpage
\input{../activity-snippets/logical-equivalence-identities-ififf.tex}
\newpage
...
\vfill
\vfill
\input{../activity-snippets/quantification-witness-counterexample.tex}
\vfill
...
\input{../activity-snippets/equivalence-relation-examples.tex}
